(module
 ...
 (export "_ZN5eosio5token9burnitallEyNS_5assetE" (func $_ZN5eosio5token9burnitallEyNS_5assetE))
 ...
 (func $_ZN5eosio5token9burnitallEyNS_5assetE (type $FUNCSIG$viji) (param $0 i32) (param $1 i64) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (i32.store offset=4
